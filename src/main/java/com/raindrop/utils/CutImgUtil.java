...
/**
 * @ClassName: cutImgUtil
 * @Description: 图片剪裁工具
 * @author liuhang liuhangbbc@sina.com
 * @date 2016年12月28日 上午11:12:31
 * 
 */
public class CutImgUtil {
	...
	public File cut(String suffix) throws IOException {
		...
		try {
			 ...
			 * 声称能够解码指定格式。 参数：formatName - 包含非正式格式名称 .
			 *
			 * (例如 "jpeg" 或 "tiff")等 。 Iterator<ImageReader> it =
	...
	public static void main(String[] args) {
		String testStr = "123.jpg";

		int over = testStr.lastIndexOf(".");
		System.out.println("first : " + testStr.substring(0, over));
		System.out.println("last : " + testStr.substring(over + 1));
	}
}
